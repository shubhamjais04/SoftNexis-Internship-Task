...
## Steps Performed
1. **Data Ingestion** - Loaded the dataset and performed initial checks 
2. **Deduplication** - Checked and removed duplicate rows
3. **Column Management** - Dropped irrelevant columns and renamed them
